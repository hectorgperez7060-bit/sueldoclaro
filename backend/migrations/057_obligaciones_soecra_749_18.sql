...
INSERT INTO public.parametro_legal
    (id,codigo,valor,unidad,ambito,valid_from,valid_to,is_verified,fuente,cct_numero,incidencias)
VALUES
    (gen_random_uuid(),'FONDO_FALLECIMIENTO_SOECRA_749/18',0.01,'%',
     'ded_todos','2026-08-01','2026-08-31',false,
    ...
    (gen_random_uuid(),'CUOTA_SINDICAL_SOECRA_749/18',0.015,'%',
     'ded_afil','2026-08-01','2026-08-31',false,
    ...
    (gen_random_uuid(),'FONDO_CONVENCIONAL_SOECRA_749/18',0.015,'%',
     'contrib_emp','2026-08-01','2026-08-31',false,
