    ...
    for cct in ccts:
        ...
        salida.append({
            ...
            "periodo_actual": {
                ...
                "mensaje_motor": (
                    "Disponibles: general, larga distancia, lácteos, auxilio, diarios, combustibles, peligrosas, residuos, taller, caudales, clearing, expreso/mudanzas y aguas gaseosas; otras ramas pendientes"
