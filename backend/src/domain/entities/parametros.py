...
class ParametroSet:
    ...
    def __init__(
        ...
        _parametros_usados: Optional[Dict[str, ParametroLegal]] = None,
    ):
        ...
        self._parametros_usados: Dict[str, ParametroLegal] = (
            _parametros_usados if _parametros_usados is not None else {}
        )
    ...
    def con_extra(self, parametro: ParametroLegal) -> "ParametroSet":
        ...
        return ParametroSet(
            ...
            _parametros_usados=self._parametros_usados,
        )
    ...
    def pendientes_usados(self) -> List[ParametroLegal]:
        ...
        return [
            p for p in self._parametros_usados.values()
